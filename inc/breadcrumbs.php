 ...
 */
function cleancoded_breadcrumb( $args = array() ) {

	$breadcrumb = apply_filters( 'cleancoded_breadcrumb_object', null, $args );

	if ( ! is_object( $breadcrumb ) )
		$breadcrumb = new cleancoded_breadcrumb( $args );
...
class cleancoded_breadcrumb {
	...
	/**
	 * Sets up the breadcrumb trail properties.  Calls the `cleancoded_breadcrumb::add_items()` method
	 ...
	 *     @type array     $labels         Text labels. @see cleancoded_breadcrumb::set_labels()
	 *     @type array     $post_taxonomy  Taxonomies to use for post types. @see cleancoded_breadcrumb::set_post_taxonomy()
	...
	public function __construct( $args = array() ) {
		...
		$this->args = apply_filters( 'cleancoded_breadcrumb_args', wp_parse_args( $args, $defaults ) );
	...
	public function trail() {
		...
		$breadcrumb = apply_filters( 'cleancoded_breadcrumb', $breadcrumb, $this->args );
	...
	protected function set_labels() {
		...
		$this->labels = apply_filters( 'cleancoded_breadcrumb_labels', wp_parse_args( $this->args['labels'], $defaults ) );
	}
	...
	protected function set_post_taxonomy() {
		...
		$this->post_taxonomy = apply_filters( 'cleancoded_breadcrumb_post_taxonomy', wp_parse_args( $this->args['post_taxonomy'], $defaults ) );
	}
	...
	protected function add_items() {
		...
		$this->items = array_unique( apply_filters( 'cleancoded_breadcrumb_items', $this->items, $this->args ) );
	}
